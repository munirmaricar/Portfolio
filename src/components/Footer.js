    ...
    <footer>
      <center>
        <div className="py-2 px-2 my-2">
          ...
          >
            <FontAwesomeIcon className="nav-item" icon={faFacebookF} />
          </a>
          <a
            className="nav-item text-xl mr-6 lg:text-lg"
            ...
            rel="noopener noreferrer"
          >
            <FontAwesomeIcon className="nav-item" icon={faTwitter} />
          </a>
          <a
            className="nav-item text-xl mr-6 lg:text-lg"
            ...
            rel="noopener noreferrer"
          >
            <FontAwesomeIcon className="nav-item" icon={faInstagram} />
          </a>
          <a
            className="nav-item text-xl mr-6 lg:text-lg"
            ...
            rel="noopener noreferrer"
          >
            <FontAwesomeIcon className="nav-item" icon={faLinkedinIn} />
          </a>
          <a
            className="nav-item text-xl mr-6 lg:text-lg"
          ...
          <a
            ...
            rel="noopener noreferrer"
          >
            <FontAwesomeIcon className="nav-item" icon={faEnvelope} />
          </a>
        </div>
        <div className="inline-flex px-1">
          <h1 className="footer-item text-lg lg:text-base">
            © {getCurrentYear()}:{" "}
            <a
              className="nav-item font-bolder no-underline hover:hoverable-on-hover"
              href="/"
            >
              Munirudeen Maricar
            </a>
